...
export default function StudentMaterials() {
  ...
  const downloadMaterial = async (material) => {
    ...
    if (!previewWindow) {
      setMessage('Please allow pop-ups to open this material.');
      return;
    }
    try {
      const filePath = material._id ? `/materials/${material._id}/file` : material.fileUrl?.replace(/^\/api/, '') || '';
